            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?=Yii::$app->params['imageDomain'].$goods->logo?>" class="jqzoom" rel="gal1">  <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <?=Html::img(Yii::$app->params['imageDomain'].$goods->logo,['style'=>'width:352px;height:352px'])?>     <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            <?php foreach ($goods->getImages()->all() as $key=>$image):?>
                            <li <?=$key==0?'class="cur"':''?>>
                                <a <?=$key==0?'class="zoomThumbActive"':''?> href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=Yii::$app->params['imageDomain'].$image->image?>',largeimage:'<?=Yii::$app->params['imageDomain'].$image->image?>'}">
                                    <?=Html::img(Yii::$app->params['imageDomain'].$image->image)?></a>
                            </li>
                            <?php endforeach;?>
                        </ul>
                    </div>
